...
namespace Helpers {
	...
	Mat MultiThreshold::MultiLim(Mat im, std::vector<unsigned int> bests, int flag) {
	...
	Mat MultiThreshold::MultiLim2(Mat im, std::vector<unsigned int> bests, int flag) {
	...
	std::vector<Mat> MultiThreshold::SplitSegmentedRegions(Mat im, std::vector<unsigned int> bests, int flag)
	{
		std::vector<unsigned int> limiares;
